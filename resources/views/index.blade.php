  ...
  <div class="row hp-row">
    <div class="col card hp-card">
        ...
        <div class="card-body">
          ...
          <p class="card-text">Utque aegrum corpus quassari etiam levibus solet offensis, ita animus eius angustus et tener, quicquid increpuisset, ad salutis suae dispendium existimans factum aut cogitatum, insontium caedibus fecit victoriam luctuosam.
